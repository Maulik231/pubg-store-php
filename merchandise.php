									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												<li><a href="merchandise.php?cat_id=4"><i class="fa fa-angle-right" aria-hidden="true"></i>Key-Chain</a></li>
											</ul>
										</div>
										<div class="col-sm-3">											
											<ul class="multi-column-dropdown">
										...
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="merchandise.php?cat_id=3"><i class="fa fa-angle-right" aria-hidden="true"></i>Mobile Cover</a></li>
											</ul>
										</div>
										<div class="col-sm-3 w3l">
