...
<div class="banner-top">
	<div class="container">
		<h3 >PUBG Branded Key-Chain</h3>
		<h4><a href="index.php">Home</a><label>/</label><a href="offer.php">Special Offer</a><label>/</label>Key-Chain</h4>
		<div class="clearfix"> </div>
	</div>
</div>
		<div class="single">
			<div class="container">
	   		...
	   		<div class="col-md-5 single-top">
	   			<?php 
					...
					$res = mysqli_query($con,"select * from homekeychainproduct where hkcp_id=".$_GET['hkcp_id']);
					
					$row=mysqli_fetch_array($res);

										$hkcp_id=$row['hkcp_id'];
										$hkcp_name=$row['hkcp_name'];
										$hkcp_price=$row['hkcp_price'];
										$hkcp_image=$row['hkcp_image'];
										$hkcp_description=$row['hkcp_description'];
							?>
	   			<div class="single-w3agile">
					<div id="picture-frame">
						<img src="images/<?php echo $hkcp_image; ?>" data-src="images/<?php echo $hkcp_image; ?>" alt="" class="img-responsive"/>
					</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3><?php echo $hkcp_description; ?></h3>
				
					
				 <div class="pr-single">
				  <p class="reduced "><del>₹1000.00</del><big><font color="red"><?php echo $hkcp_price; ?></font></big></p>
				</div>
				<div class="block block-w3">
					<div class="starbox small ghosting"> </div>
				</div>
				<p class="in-pa">&gt;&nbsp;&nbsp;<?php echo $hkcp_description; ?>
				...
				<h3>Special Offers</h3>
					<div class="ser-t">
						...
						<div class=" con-w3l wthree-of">
							<?php 
								$con = mysqli_connect('localhost','root','','demodatabase');
								$res = mysqli_query($con,"select * from homekeychainproduct LIMIT 4 ");
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="singlekeychain.php?hkcp_id=<?php echo $hkcp_id; ?>" >
										<img src="images/<?php echo $hkcp_image; ?>" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="singlekeychain.php?hkcp_id=<?php echo $hkcp_id; ?>"<?php echo $hmcp_name; ?></h6>							
										</div>
										<div class="mid-2">
											<p ><label><?php echo $hkcp_price; ?></label><em class="item_price">$0.70</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
