...
<div class="banner-top">
	<div class="container">
		<h3 >Weapons</h3>
		<h4><a href="index.html">Home</a><label>/</label>addtocart</h4>
		<div class="clearfix"> </div>
	</div>
</div>
<div class="page-header">
            <center><h3 class="bars">Cart-Details</h3></center>
          </div>
          <form>
...
while($ro=mysqli_fetch_row($re))
{
	...
	$pro_id= $ro[0];
	$que="select * from product where p_id='".$pro_id."'";
	...
	while($row=mysqli_fetch_row($resu))
	 {
		...
		echo "<td>".$row[9]."</td>";
		echo "<td>";
        echo "<a href='delet_cart.php?id=".$ro[4]."'><font color='red'>Remove</font></a>";
        echo "</td>";
...
// {
	$query="select sum(p_price) from addtocart where c_id='".$c_id."'";
	$result=mysqli_query($con,$query);
	$row=mysqli_fetch_row($result);	
	echo "</br><center>Total Price Of All Product:";
	echo $row[0];
	echo "</center></br>";
...
<form method="POST" action="bill.php">
	<input type="hidden" name="totalprice" value="<?php echo $row[0];?>">
	<center><input value="Buynow all Product" type="submit" name="buyall"></center>
</form>
</br></br>
<div class="page-header">
            <center><h3 class="bars">Order-Detail</h3></center>
          </div>
<form>
		...
		<table class="table table-hover">
              ...
              <?php
              	...
              	$q="select * from order_master where c_id='".$c_id."'";
