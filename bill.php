...
<html>
<head>
<title>PUBG STORE is a Ecommerce Online Shopping </title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
	<div class="container">
		<h3 >Bill</h3>
		<h4><a href="index.html">Home</a><label>/</label>Bill</h4>
		<div class="clearfix"> </div>
	</div>
</div>
<div id="printable">
	<center>
<big>PUBG STORE</big><span> Best One Stop Solution</span>
</center>
<div class="page-header">
            <center><h3 class="bars">Bill</h3></center>
          </div>
...
<div class="container" style="background-color: #0001;">
	<form method="POST"	action="order.php">
		<h4>Name: <?php echo $roww[1]; ?></h4>
		<h4>Address: <?php echo $roww[5]; ?></h4>
		<?php $address=  $roww[5];?>
...
?>
	...
	$i=1;
	$query="select * from addtocart where c_id='".$c_id."'";
	...
	while($row=mysqli_fetch_row($result))
	{
		...
		$a="INSERT INTO `order_master`(`o_date`,`c_id`,`deli_date`,`amount`,`p_id`,`trac_id`,`pay_type`,`address`) values('".date("d/m/y")."','".$c_id."','".date("d/m/y",strtotime("+5 day"))."','".$pric."','".$p_id."','".$trac_id."','".$pay_type."','".$address."'')";
...
<h4>Total Amount:<?php echo $_POST['totalprice'];?></h4>
</div><button class="btn btn-success" onclick="myFunction('printable')">Print</button>
